...
def scan(rfile):
    ...
    print("list: "+str(LIST_OF_FILES_PDF))
    ...
    for i in Resume_Vector:
        ...
        Ordered_list_Resume_Score.extend(neigh.kneighbors(r_Desc)[0][0].tolist())
    ...
    for n,i in enumerate(Z):
        ...
        flask_return.append(name)
        # res.printresult()
        print(str(n+1)+str(name))
    return flask_return
